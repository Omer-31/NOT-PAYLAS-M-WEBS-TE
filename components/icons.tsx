...
export const AcademicCapIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
        ...
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 14l9-5-9-5-9 5 9 5zm0 0l6.16-3.422a12.083 12.083 0 01.665 6.479A11.952 11.952 0 0012 20.055a11.952 11.952 0 00-6.824-5.998 12.078 12.078 0 01.665-6.479L12 14zm-4 6v-7.5l4-2.222 4 2.222V20M1 12v5a1 1 0 001 1h20a1 1 0 001-1v-5" />
    </svg>
);
...
export const PaletteIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M12.75 3.03v.568c0 .334.148.65.405.864l1.068.89c.442.369.535 1.01.216 1.49l-.51.766a2.25 2.25 0 01-1.161.886l-.143.048a1.107 1.107 0 00-.57 1.664c.369.555.169 1.307-.427 1.605L9 13.125l.423 1.059a.956.956 0 01-1.652.928l-.679-.906a1.125 1.125 0 00-1.906.172L4.5 15.75l-.612.153M12.75 3.031a9 9 0 00-8.862 12.872M12.75 3.031a9 9 0 016.69 14.036m0 0l-.177.177a.938.938 0 00-1.326 0l-3.878-3.878a.938.938 0 00-1.327 0l-3.878 3.878a.938.938 0 000 1.326l.177.177m0 0c-.097.097-.233.145-.37.145A.5.5 0 019 21.125v-2.872a2.25 2.25 0 01.75-1.581l1.401-1.401a2.25 2.25 0 011.581-.75h1.581a2.25 2.25 0 011.581.75l1.401 1.401a2.25 2.25 0 01.75 1.581v2.872a.5.5 0 01-.5.5c-.137 0-.273-.048-.37-.145z" />
    </svg>
);
...
export const MedalIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
        ...
        <path strokeLinecap="round" strokeLinejoin="round" d="M15.91 15.91L18 18M8.09 15.91L6 18M12 21V18M12 3L10.5 4.5M12 3L13.5 4.5" />
    </svg>
);
