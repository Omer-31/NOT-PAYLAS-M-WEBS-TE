...
import { StarIcon, ArrowLeftIcon, MagicWandIcon, QuizIcon, HeartIcon } from './icons';
        ...
        <div className="space-y-8">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="space-y-6">
                    ...
                    <div className="bg-white dark:bg-gray-800/50 rounded-xl border border-gray-200 dark:border-gray-700/50 p-6">
                        <h3 className="font-bold text-lg mb-2 text-gray-900 dark:text-white">Favoriler</h3>
